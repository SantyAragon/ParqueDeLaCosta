	...
	<section>
		<div class="container d-flex flex-column">
			<div class="d-flex align-items-center">
				<div class="cards">
					<img class="card-img-top" src="img/vertigo_extremo.jpg" alt="100px">
					<div class="card-body">
				...
				<div class="cards">
					...
					<div class="card-body">
						...
						<p class="card-text">Altura minima requerida 1,20 M Menores
							de 10 años aunque lleguen a la altura minima requerida deberan
			...
			<div class="d-flex align-items-center">
				<div class="cards">
					<img class="card-img-top" src="img/torbellino.jpg" alt="100px">
					<div class="card-body">
						<h4 class="card-title">Torbellino</h4>
						<p class="card-text">Altura maxima requerida 1,30 M.</p>
						<a href="https://youtu.be/DrK6pBKH-D0"
							class="btn btn-primary btn-atracciones">Ver</a>
					</div>
				</div>
				<div class="cards">
					<img class="card-img-top" src="img/desafio.jpg" alt="100px">
					<div class="card-body">
						<h4 class="card-title">El desafio</h4>
						<p class="card-text">Altura maxima requerida 1,30 M Menores de
							10 años aunque lleguen a la altura minima requerida deberan
							subir con un adulto responsable directo.</p>
